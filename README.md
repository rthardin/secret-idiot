...
Secret Idiot is a real-time social deduction game for groups. One player is secretly the Agent with a covert mission: something silly, subtle, or conspicuous. Everyone else tries to figure out who it is.
...
| Sick Burn (correct burn) | Burner +1 |
